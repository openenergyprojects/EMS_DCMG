...
% % %       InputData.Ppv(2)=0.5*(InputData.Ppv(2)+InputData.Ppv(1))/2+0.3*InputData.Ppv(2)+0.2*InputData.Ppv(3);
      ...
      InputData.Ppv(1:24)= PV_24h(InputData.timeStart:InputData.timeStart+4*InputData.timeHorizon-1); 
        ...
        InputData.Pload(1:24)= Pload_24h(InputData.timeStart:InputData.timeStart+4*InputData.timeHorizon-1);  
        PloadNext24points=Pload_24h(InputData.timeStart:InputData.timeStart+4*InputData.timeHorizon-1);
