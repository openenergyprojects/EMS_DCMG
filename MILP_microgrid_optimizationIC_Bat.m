function [Value]=MILP_microgrid_optimizationIC_Bat(InputData)
% clear all;
% close all;
% clc;
...
initial_capacity_battery=InputData.SoC/1000;%0.5*maximum_capacity_battery; %=maximum_capacity_battery/2%KWh %S0C_@t=0 starts at 50% from the rated capacity of the battery: 
